package com.pm.aa.fragments.update
...
class UpdateFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.updateProductMarca.setText(args.currentProduct.marca)
        view.updateProductTeor.setText(args.currentProduct.teor)
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        inflater.inflate(R.menu.menu_update_delete_garrafa, menu)
    }
    ...
    private fun updateProduct() {
        ...
        val product = Product(args.currentProduct.id, updateProductName.text.toString(), updateProductMarca.text.toString(), updateProductTeor.text.toString())
